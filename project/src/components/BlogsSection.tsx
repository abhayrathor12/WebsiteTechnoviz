              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex items-center space-x-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span>
                      {new Date(blogPosts[0].publish_date).toLocaleDateString(
                        'en-US',
                        {
                          year: 'numeric',
                          month: 'long',
                ...
                <Link
        to={`/blogs/${blogPosts[0].slug}`} className="bg-[#203f78] text-white px-6 py-2 rounded-full hover:bg-[#ddaf26] transition-colors flex items-center space-x-2">
                  <span>Read More</span>
