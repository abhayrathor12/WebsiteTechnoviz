...
import { caseStudies, blogPosts as mockBlogPosts } from '../data/mockData';
...
const CaseStudiesAndBlogsPage: React.FC = () => {
  ...
  // Combine mock + API blogs once API is loaded
  useEffect(() => {
    if (!loadingApi) {
      // Mock posts first, then API posts
      setAllBlogPosts([...mockBlogPosts, ...apiBlogPosts]);
    }
  }, [loadingApi, apiBlogPosts]);
