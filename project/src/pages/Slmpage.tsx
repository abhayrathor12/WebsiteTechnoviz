...
const Login = () => {
    ...
    return (
        <>
            <Header />
            <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 min-h-screen scroll-smooth pt-16 lg:pt-20">
      ...
      `}</style>
                ...
                {/* STICKY NAVBAR */}
                <div className="sticky top-16 lg:top-20 z-40 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
